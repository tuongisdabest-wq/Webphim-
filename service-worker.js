...
const CACHE_NAME = 'ktuongfx-shell-v1';
const SHELL_FILES = [
  './',
  './index.html',
  './manifest.json',
...
self.addEventListener('fetch', (event) => {
  ...
  // Trang HTML (điều hướng): network-first — luôn ưu tiên bản mới nhất khi có mạng,
  // chỉ dùng bản cache khi mất mạng, để user không bị kẹt xem bản cũ vĩnh viễn.
  ...
  // Static shell khác (manifest, logo...): cache-first, tự cập nhật cache nền sau đó.
  event.respondWith(
